...
from maf_telemetry import instrument_app, TelemetryConfig
...
def create_app():
    ...
    instrument_app(app, TelemetryConfig(
        service_name="drafting-agent",
        service_version="0.0.1",
        service_id="AGT-C-002",
        enable_raw_interaction_id=True,
    ))
